                                                    ...
                                                    <form action="komentar/create" class="comment-form" method="POST">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <?php foreach(array_reverse($transaksis) as $index=>$transaksi): ?>
                                                                <option value="<?= $transaksi->id_barang ?>">Transaction <?= $transaksi->created_date ?></option>
                                                                <?php endforeach ?>
                                                                </select>
                                                            </div> 
                                                            <div class="col-lg-12, col py-4">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <p  ><a  class="text-primary link-dark-100" href="<?= site_url('invoice/'.$transaksi->id.'') ?>">Transaction <?= $transaksi->created_date ?></a></p>
                                        <?php endforeach ?> 
                                    </div>
                                </div>
                            </div> 

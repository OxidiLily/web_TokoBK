                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-desc"> 
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" id="voucherDiskon">
                                                <option>Diskon Yang Tersedia</option>
                                                    <?php foreach($diskons as $d): ?>
                                                        <?php
                                                    if ($d->Aktif == 1) : ?>
                                                       <option value="<?= $d->Besar_diskon?>"> Kode : <?= $d-> Kode_voucher?>  ||  Besar Diskon: <?= $d->Besar_diskon?></option>
                                        ...
                                        <div class="comment-option"> 
                                            ...
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="<?= base_url('public/fashi-master/img/product-single/avatar-2.png') ?>" alt="">
                                                </div>
...
<script>
	$('document').ready(function(){
        ...
        // Diskon
        $("#voucherDiskon").on('change', function() {
